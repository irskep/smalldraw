  ...
  return (
    <section className="portal-page" aria-label="Terms and conditions">
      <div className="portal-page__header">
        ...
        <ul>
          ...
          <li>
            <p>
              ...
              in these Terms and Conditions) refers to Splatterboard.
            </p>
          </li>
          <li>
            <p>
          ...
          <li>
            <p>
              <strong>Website</strong> refers to Splatterboard, accessible from{" "}
              <a
                href="https://splatterboard.app/"
        ...
        <ul>
          <li>By email: contact@splatterboard.app</li>
        </ul>
      </div>
    </section>
  );
