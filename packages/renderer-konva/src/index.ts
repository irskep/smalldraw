...
export { createFreehandStroke, flattenOutline, outlineToPath } from './stroke.js';
export type { RenderDocumentOptions, CreateStageOptions, ReconcileDocumentOptions } from './document.js';
export { createStage, ensureRendererLayer, renderDocument, reconcileDocument } from './document.js';
