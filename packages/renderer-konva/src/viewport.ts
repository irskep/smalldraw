...
export function applyViewportToStage(stage: Stage, layer: Layer, viewport: Viewport): void {
...
function getLayerPositionForViewport(viewport: Viewport): { x: number; y: number } {
  return {
