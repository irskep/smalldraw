...
- [CustomGeometry](interfaces/CustomGeometry.md)
...
- [GeometryOperations](interfaces/GeometryOperations.md)
...
- [NormalizedLayout](interfaces/NormalizedLayout.md)
...
- [ResizeOperation](interfaces/ResizeOperation.md)
- [ResizeResult](interfaces/ResizeResult.md)
- [ResizeSnapshot](interfaces/ResizeSnapshot.md)
...
- [ShapeHandler](interfaces/ShapeHandler.md)
- [ShapeInteractions](interfaces/ShapeInteractions.md)
- [ShapeOperations](interfaces/ShapeOperations.md)
